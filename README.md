...
If you already have ubuntu machine, configure in hosts.yml file and run below command:

    ansible-playbook -i hosts.yml test.yml -e "mysql_current_root_password='' mysql_root_password='root'" -u ubuntu --sudo
